            ...
            <div class="row text-center">
              ...
              <div class="col-md-4">
                ...
                <div class="card-body pb-0">
                  ...
                  <div class="my-3"></div>
                  <a class="btn btn-indigo btn-sm has-text-white" href="/view/{{getBoardingTypeIdById($post->id)}}/{{getPropertyTypeIdById($post->id)}}"><i class="fas fa-clone left"></i> See More</a>
                </div>
              </div>
              @endforeach
            </div> 
