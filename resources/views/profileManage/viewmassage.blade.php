            ...
            <div class="top">
              <div>
                <figure class="image is-64x64 ">
                  ...
                  @else
                  <img src="/images/prof.jpg" alt="Image" class="is-rounded"> @endif
                </figure>
                <div class="address">
                  ...
                  <div class="subtitle is-7 is-pulled-right">Regarding :<span class="subtitle is-7"> <a href="/{{$message->property_url}}" target="_blank">View Boarding Property</a></span>
                  <br> 
