...
<body class="has-background-white-ter">
    ...
    <div class="section is-medium">
        <div class="">
            <form action="/update/singleRoomRequests" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="column is-6">
                        <div class="box has-background-white-bis">
                            ...
                            <div class="columns is mobile is-centered">
                                ...
                                <input type="text" name="boardingrequestid" value="{{$singleRoomRequest->boardingrequest->id}}" hidden>
                                <input type="text" name="singleroomrequestid" value="{{$singleRoomRequest->id}}" hidden>
                            </div>
                            <div class="my-4"></div>
                            <div class="columns">
                                <div class="column is-6">
                                    ...
                                    <div class="control is-6">
                                        <div class="select is-primary">
                                            <select name="boardingrequestType">
                                                <option value="Annex">AnexRequst</option>                                                    
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="control is-6 ">
                                                <div class="select is-primary">
                                                    <select name="NoOfRooms">
                                                        <option value="1"
                                                            @if($singleRoomRequest->NoOfRooms == '1')
                                                            selected
                                                            @endif
                                                        >1</option>
                                                        <option value="2"
                                                            @if($singleRoomRequest->NoOfRooms == '2')
                                                            selected
                                                            @endif
                                                        >2</option>
                                                        <option value="3"
                                                            @if($singleRoomRequest->NoOfRooms == '3')
                                                            selected
                                                            @endif
                                                        >3</option>
                                                        <option value="4"
                                                            @if($singleRoomRequest->NoOfRooms == '4')
                                                            selected
                                                            @endif
                                                        >4</option>
                                                        <option value="More"
                                                            @if($singleRoomRequest->NoOfRooms== 'More')
                                                            selected
                                                            @endif
                                                        >More</option> 
                                                    </select>
                                            ...
                                            <div class="control is-6 has-icon-left">
                                                <div class="select is-primary">
                                                    <select name="NoOfBed">
                                                        ...
                                                        <option value="1"
                                                            @if($singleRoomRequest->NoOfBed == '1')
                                                            selected
                                                            @endif
                                                        >1</option>
                                                        <option value="2"
                                                            @if($singleRoomRequest->NoOfBed == '2')
                                                            selected
                                                            @endif
                                                        >2</option>
                                                        <option value="3"
                                                            @if($singleRoomRequest->NoOfBed == '3')
                                                            selected
                                                            @endif
                                                        >3</option>
                                                        <option value="4"
                                                            @if($singleRoomRequest->NoOfBed == '4')
                                                            selected
                                                            @endif
                                                        >4</option>
                                                        <option value="More"
                                                            @if($singleRoomRequest->NoOfBed== 'More')
                                                            selected
                                                            @endif
                                                        >More</option>                                                                                                                       
                                                    </select>
                                                ...
                                                <div class="field">
                                                    <div class="columns is-centered">
                                                        <div class="column is-6 is-centered">
                                                            ...
                                                            @if ($singleRoomRequest->Acavalability  == 'Yes')
                                                                checked
                                                            @endif>
                                                        ...
                                                        <div class="column is-6">
                                                            <input class="is-checkradio is-rtl" id="exampleRtlRadioInline2" type="radio" value="No" name="Acavalability"
                                                             @if ($singleRoomRequest->Acavalability  == 'No')
                                                            checked
                                                        @endif>
                                                ...
                                                <div class="field">
                                                    <div class="columns is-centered">
                                                        <div class="column is-6 is-centered">
                                                            ...
                                                            @if ($singleRoomRequest->kitchenavalability  == 'Yes')
                                                                checked
                                                            @endif>
                                                            <label for="exampleRtlRadioInline1">Yes</label>
                                                        </div>
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->kitchenavalability  == 'No')
                                                                checked
                                                            @endif>
                                                            <label for="exampleRtlRadioInline2">No</label>
                                                        </div>
                                                    ...
                                                    <div class="field">
                                                        <div class="columns is-centered">
                                                            <div class="column is-6 is-centered">
                                                                ...
                                                                @if ($singleRoomRequest->Withfurniture   == '1')
                                                                    checked
                                                                @endif>
                                                                <label for="exampleRtlRadioInline1">Yes</label>
                                                            </div>
                                                            <div class="column is-6">
                                                                ...
                                                                @if ($singleRoomRequest->Withfurniture   == '0')
                                                                    checked
                                                                @endif>
                                                                <label for="exampleRtlRadioInline2">No</label>
                                                            </div>
                                                ...
                                                <div class="field">
                                                    <div class="columns">
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->boardingrequest->School_boys  == '1')
                                                                checked
                                                            @endif>
                                                        ...
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->boardingrequest->School_girls  == '1')
                                                                checked
                                                            @endif>
                                                    ...
                                                    <div class="columns">
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->boardingrequest->Uni_boys  == '1')
                                                                checked
                                                            @endif>
                                                        ...
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->boardingrequest->Uni_girls   == '1')
                                                                checked
                                                            @endif>
                                                    ...
                                                    <div class="columns">
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->boardingrequest->Office_boys  == '1')
                                                                checked
                                                            @endif>
                                                        ...
                                                        <div class="column is-6">
                                                            ...
                                                            @if ($singleRoomRequest->boardingrequest->Office_girls  == '1')
                                                                checked
                                                            @endif>
                            ...
                            <div class="columns">
                                ...
                                <div class="column is-6">
                                    ...
                                    <input class="input" type="text" placeholder="Text input" name="MonthlyRent" value="{{$singleRoomRequest->boardingrequest->MonthlyRent}}">
                            ...
                            <div class="columns">
                                ...
                                <div class="column is-6">
                                    <div class="control has-icons-left has-icons-right">
                                        <input class="input" type="text" placeholder="Text input" value="{{$singleRoomRequest->boardingrequest->KeyMoney}}" name="KeyMoney">
                                        <span class="icon is-small is-left">
                                            <i class="fas fa-user"></i>
                                        </span>
                                        <span class="icon is-small is-right">
                            ...
                            <div class="columns">
                                <div class="column is-12">
                                    <div class="field">
                                        ...
                                        <div class="field">
                                            <div class="control">
                                                <textarea class="textarea" placeholder="Textarea" name="Description">{{$singleRoomRequest->boardingrequest->Description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                <select name="Province" class="form-control form-control-lg" id="province">
                                                    <option value="Central Province"
                                                            @if($singleRoomRequest->boardingrequest->Province == 'Central Province')
                                                            selected
                                                            @endif
                                                    >Central Province</option>
                                                    <option  value="Eastern Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Eastern Province')
                                                        selected
                                                        @endif
                                                    >Eastern Province</option>
                                                    <option  value="Northern Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Northern Province')
                                                        selected
                                                        @endif
                                                    >Northern Province</option>
                                                        <option  value="Southern Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Southern Province')
                                                        selected
                                                        @endif
                                                    >Southern Province</option>
                                                    <option  value="Western Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Western Province')
                                                        selected
                                                        @endif
                                                    >Western Province</option>
                                                    <option  value="North Western Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'North Western Province')
                                                        selected
                                                        @endif
                                                    >North Western Province</option>
                                                    <option  value="North Central Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'North Central Province')
                                                        selected
                                                        @endif
                                                    >North Central Province</option>
                                                    <option  value="Uva Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Uva Province')
                                                        selected
                                                        @endif
                                                    >Uva Province</option>
                                                    <option  value="Sabaragamuwa Province"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Sabaragamuwa Province')
                                                        selected
                                                        @endif
                                        ...
                                        <div class="control has-icons-left has-icons-right">
                                            <div class="form-group">
                                                <select name="District" class="form-control form-control-lg" id="distric">
                                                    <option value="Ampara"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Ampara')
                                                        selected
                                                        @endif
                                                    >Ampara</option>
                                                    <option  value="Anuradhapura"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Anuradhapura')
                                                        selected
                                                        @endif
                                                    >Anuradhapura</option>
                                                    <option  value="Badulla"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Badulla')
                                                        selected
                                                        @endif
                                                    >Badulla</option>
                                                    <option  value="Batticaloa"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Batticaloa')
                                                        selected
                                                        @endif
                                                    >Batticaloa</option>
                                                    <option  value="Colombo"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Colombo')
                                                        selected
                                                        @endif
                                                    >Colombo</option>
                                                    <option  value="Galle"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Galle')
                                                        selected
                                                        @endif
                                                    >Galle</option>
                                                    <option  value="Gampaha"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Gampaha')
                                                        selected
                                                        @endif
                                                    >Gampaha</option>
                                                    <option  value="Hambantota"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Hambantota')
                                                        selected
                                                        @endif
                                                    >Hambantota</option>
                                                    <option  value="Kalutara"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Kalutara')
                                                        selected
                                                        @endif
                                                    >Kalutara</option>
                                                    <option  value="Kandy"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Kandy')
                                                        selected
                                                        @endif
                                                    >Kandy</option>
                                                    <option  value="Kegalle"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Kegalle')
                                                        selected
                                                        @endif
                                                    >Kegalle</option>
                                                    <option  value="Kilinochchi"
                                                        @if($singleRoomRequest->boardingrequest->Province == 'Kilinochchi')
                                                        selected
                                                        @endif
                                                    >Kilinochchi</option>
                                                    <option  value="Kurunegala"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Kurunegala')
                                                        selected
                                                        @endif
                                                    >Kurunegala</option>
                                                    <option  value="Mannar"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Mannar')
                                                        selected
                                                        @endif
                                                    >Mannar</option>
                                                    <option  value="Matale"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Matale')
                                                        selected
                                                        @endif
                                                    >Matale</option>
                                                    <option  value="Matara"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Matara')
                                                        selected
                                                        @endif
                                                    >Matara</option>
                                                    <option  value="Monaragala"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Monaragala')
                                                        selected
                                                        @endif
                                                    >Monaragala</option>
                                                    <option  value="Mullaitivu"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Mullaitivu')
                                                        selected
                                                        @endif
                                                    >Mullaitivu</option>
                                                    <option  value="Nuwara Eliya"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Nuwara Eliya')
                                                        selected
                                                        @endif
                                                    >Nuwara Eliya</option>
                                                    <option  value="Polonnaruwa"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Polonnaruwa')
                                                        selected
                                                        @endif
                                                    >Polonnaruwa</option>
                                                    <option  value="Puttalam"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Puttalam')
                                                        selected
                                                        @endif
                                                    >Puttalam</option>
                                                    <option  value="Ratnapura"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Ratnapura')
                                                        selected
                                                        @endif
                                                    >Ratnapura</option>
                                                    <option  value="Trincomalee"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Trincomalee')
                                                        selected
                                                        @endif
                                                    >Trincomalee</option>
                                                    <option  value="Vavuniya"
                                                        @if($singleRoomRequest->boardingrequest->District == 'Vavuniya')
                                                        selected
                                                        @endif
                                                    >Vavuniya</option>                                   
                                                </select>
                            ...
                            <div class="columns">
                                <div class="column is-12">
                                    <div class="field">
                                        ...
                                        <div class="control has-icons-left has-icons-right">
                                            <input class="input" type="text" placeholder="Text input" name="City" value="{{$singleRoomRequest->boardingrequest->City}}" required>
                                            <span class="icon is-small is-left">
                                                <i class="fas fa-user"></i>
                                            </span>
                                            <span class="icon is-small is-right">
                                ...
                                <div class="columns">
                                    <div class="column is-12">
                                        <div class="field">
                                            ...
                                            <div class="control has-icons-left has-icons-right">
                                                <input class="input" type="text" placeholder="Text input" name="Email" value="{{$singleRoomRequest->boardingrequest->Email}}">
                                                <span class="icon is-small is-left">
                                                    <i class="fas fa-user"></i>
                                                </span>
                                                <span class="icon is-small is-right">
                                ...
                                <div class="columns">
                                    <div class="column is-12">
                                        <div class="field">
                                            ...
                                            <div class="control has-icons-left has-icons-right">
                                                <input class="input" type="text" placeholder="Text input" name="Telephone" value="{{$singleRoomRequest->boardingrequest->Telephone}}">
                                                <span class="icon is-small is-left">
                                                    <i class="fas fa-user"></i>
                                                </span>
                                                <span class="icon is-small is-right">
